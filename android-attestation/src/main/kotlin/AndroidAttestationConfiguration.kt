...
data class AndroidAttestationConfiguration @JvmOverloads constructor(
    ...
    /**
     * Manually specify the trust anchors for HW-attested certificate chains as Base64-encoded strings holding X.509-encoded public keys.
    ...
    /**
     * Manually specify the trust anchor for SW-attested certificate chains as Base64-encoded strings holding X.509-encoded public keys.
     * The reason for this format in the default constructor is to make file-based configuration through [Hoplite](https://github.com/sksamuel/hoplite) a breeze.
